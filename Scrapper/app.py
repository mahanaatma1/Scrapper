...
async def run_scraper():
    ...
    try:
        ...
        # Scrape listings
        scraping_logger.info("Scraping listings from configured cities...")
...
async def update_config(config_update: ConfigUpdate):
    ...
    try:
        ...
        if 'cities' in update_dict:
            CRAIGSLIST_CITIES = update_dict['cities']
        if 'base_url' in update_dict and update_dict['base_url']:
            CRAIGSLIST_BASE_URL = update_dict['base_url']
